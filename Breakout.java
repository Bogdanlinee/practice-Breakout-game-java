package com.shpp.p2p.cs.bberezin.assignment4;
...
public class Breakout extends WindowProgram {
    ...
    /* Start condition: the program does not have bricks which are forming the colored ceiling.
     *
     * Result: program has a colored ceiling which consists of 10 rows. Each row has its
     * own color and consists of 10 bricks.
     */
    private void tenRowsOfBricks() {
        ...
        for (int i = 0; i < NBRICK_ROWS; i++) {
            ...
            for (int j = 0; j < NBRICKS_PER_ROW; j++) {
                // add brick to html with using parameters
    ...
    /* Start condition: user can not see how many bricks he/she has to break to finish the game.
     *
     * Result: in the left low corner user can see how many bricks left to finish the game.
     */
    ...
    /* Start condition: user can not see how many attempts he/she has to win the game.
     *
     * Result: user can see how many attempts he/she has.
     */
    ...
    /* Start condition: function has x,y coordinates and current
     * number of the row.
     *
     * Result: the program built a brick using coordinates and
    ...
    /* Start condition: program do not have a paddle to play the game
     *
     * Result: program has a paddle to play the game
     */
    ...
    /* Start condition: paddle can not follow users` mouse
     *
     * Result: paddle can follow users` mouse. Mouse x-axis coordinate always
    ...
    /* Start condition: application do not have any ball to play with.
     *
     * Result: application have a ball. The ball is animated.
     */
    ...
    /* Start condition: application do not have any ball.
     *
     * Result: application have a black ball.
     */
    ...
    /* Start condition: ball is static.
     *
     * Result: the ball is animated, it bounces from each wall.
     */
     ...
     *
     * Result: function returns object if ball met it.
     */
    ...
    /* Start condition: ball met brick.
     *
     * Result: text value of the bricksCounterLabel changed. It decreased.
     */
    ...
    /* Start condition: user missed one of his lives.
     *
     * Result: counter decreased.
     */
    ...
    /* Start condition: game is over.
     *
     * Result: user can see his/her result.
     */
